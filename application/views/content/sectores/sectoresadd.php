                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box form-horizontal">
                            <form action="<?php echo base_url();?>sectores/register" method="POST">
                            <div class="form-group <?php echo !empty(form_error("sector"))? 'has-error' : ''?>">
                                <label class="col-sm-3 control-label">Sector *</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="sector" placeholder="Ingrese sector" value="<?php echo set_value("sector");?>">
